...
public class PictureService : IPictureService
{
    ...
    public async Task<PictureDto> AddPictureToPostAsync(int postId, IFormFile file)
    {
        ...
        var existingPicture = await _pictureRepository.GetByPostIdAsync(postId);
        ...
        var picture = new Picture()
        {
            ...
            Name = file.FileName,
            Image = file.GetBytes(),
            Main = existingPicture.Count() == 0 ? true : false
        };
    ...
    public async Task SetMainPicutreAsync(int postId, int id)
    {
